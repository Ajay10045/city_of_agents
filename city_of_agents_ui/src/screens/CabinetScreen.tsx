  ...
  return (
    <div style={{ marginBottom: 5 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 2 }}>
        <span style={{ fontSize: 9, color: '#94a3b8', fontFamily: "'Rajdhani', sans-serif",
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, height: 52, display: 'flex', alignItems: 'center',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 700, fontSize: 14,
              color: '#f0c040', letterSpacing: '0.06em', textTransform: 'uppercase' }}>City of {state.city_name}</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginLeft: 32 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '4px 12px', borderRadius: 14,
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '5px 12px',
            ...
            <input
              ...
              style={{ background: 'none', border: 'none', outline: 'none', color: '#cbd5e1',
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden', position: 'relative', zIndex: 1 }}>
          ...
          <div className="custom-scrollbar" style={{ flex: 1, overflowY: 'auto' }}>
            {!interviewee ? (
              ...
              <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ background: 'linear-gradient(180deg, rgba(232,160,48,0.05) 0%, rgba(7,16,28,0.6) 100%)',
                  ...
                  <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 9, fontWeight: 700,
                    letterSpacing: '0.15em', color: '#e8a030', marginBottom: 2 }}>CANDIDATE POTENTIAL</div>
                  <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 13, fontWeight: 700,
                    color: '#fff', letterSpacing: '0.04em', marginBottom: 4 }}>APTITUDE PROFILE</div>
                  ...
                  {meta && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginTop: 6,
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: 9, color: '#64748b', fontFamily: "'Rajdhani', sans-serif",
                          fontWeight: 600 }}>Strategic Alignment</span>
                        <span style={{ fontSize: 11, fontFamily: "'Share Tech Mono', monospace",
                          color: '#22c55e', fontWeight: 700 }}>{meta.strategicAlignment}%</span>
                      </div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: 9, color: '#64748b', fontFamily: "'Rajdhani', sans-serif",
                          fontWeight: 600 }}>Political Risk</span>
                        <span style={{ fontSize: 11, fontFamily: "'Share Tech Mono', monospace",
                          color: meta.politicalRisk === 'Low' ? '#22c55e' : meta.politicalRisk === 'Medium' ? '#e8a030' : '#f87171',
                          fontWeight: 700 }}>{meta.politicalRisk}</span>
                      </div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: 9, color: '#64748b', fontFamily: "'Rajdhani', sans-serif",
                          fontWeight: 600 }}>Cost of Service</span>
                        <span style={{ fontSize: 11, fontFamily: "'Share Tech Mono', monospace",
                          color: '#cbd5e1', fontWeight: 700 }}>{meta.costOfService} <span style={{ fontSize: 8, color: '#4b6280' }}>CR</span></span>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div>
                  <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 9, fontWeight: 700,
                    letterSpacing: '0.15em', color: '#e8a030', marginBottom: 6 }}>CAPABILITY</div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden',
          ...
          {!interviewee ? (
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center',
              ...
              <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 14, color: '#1c3652',
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center',
              ...
              <div style={{ position: 'absolute', top: 32, left: 32, zIndex: 5,
                ...
                <div style={{ fontSize: 8, color: '#38bdf8', fontFamily: "'Rajdhani', sans-serif",
                  fontWeight: 700, letterSpacing: '0.1em' }}>TARGET ID</div>
                <div style={{ fontSize: 14, color: '#fff', fontFamily: "'Share Tech Mono', monospace",
                  fontWeight: 700, letterSpacing: '0.06em' }}>{generateTargetId(interviewee)}</div>
              </div>

              {/* Active Scan badge */}
              <div style={{ position: 'absolute', bottom: 100, right: 32, zIndex: 5,
                display: 'flex', alignItems: 'center', gap: 6,
                background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.3)',
                borderRadius: 4, padding: '5px 10px' }}>
                <span style={{ fontSize: 9, color: '#4b6280', fontFamily: "'Share Tech Mono', monospace" }}>radar</span>
                <span style={{ fontSize: 9, color: '#22c55e', fontFamily: "'Rajdhani', sans-serif",
                  fontWeight: 700, letterSpacing: '0.1em',
                  animation: 'pulse 2s infinite' }}>ACTIVE SCAN</span>
              </div>
              ...
              <div style={{ textAlign: 'center', marginTop: 20, zIndex: 3 }}>
                <div style={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 700, fontSize: 36,
        ...
        <div style={{ width: 300, flexShrink: 0, display: 'flex', flexDirection: 'column',
          ...
          <div style={{ padding: '11px 14px 9px', borderBottom: '1px solid #1c3652', flexShrink: 0 }}>
            <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 9, fontWeight: 700,
              letterSpacing: '0.15em', color: '#e8a030', marginBottom: 1 }}>IMPACT FORECAST</div>
            <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 13, fontWeight: 700,
              color: '#fff', letterSpacing: '0.04em' }}>CITY PARAMETERS</div>
          </div>
          ...
          <div className="custom-scrollbar" style={{ flex: 1, overflowY: 'auto', padding: '12px 14px' }}>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 9, fontFamily: "'Rajdhani', sans-serif", letterSpacing: '0.15em',
                color: '#38bdf8', fontWeight: 700, marginBottom: 6 }}>LAYER A · ECONOMIC & INFRA</div>
              {[
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 9, fontFamily: "'Rajdhani', sans-serif", letterSpacing: '0.15em',
                color: '#a78bfa', fontWeight: 700, marginBottom: 6 }}>LAYER B · HUMAN & SOCIAL</div>
              {[
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 9, fontFamily: "'Rajdhani', sans-serif", letterSpacing: '0.15em',
                color: '#4ade80', fontWeight: 700, marginBottom: 6 }}>LAYER C · SAFETY & ENV</div>
              {[
      ...
      {/* ── BOTTOM CAROUSEL ──────────────────────────────────────────────────── */}
      <div style={{ flexShrink: 0, borderTop: '1px solid #1c3652', position: 'relative',
        background: 'linear-gradient(180deg, #071320 0%, #050d1b 100%)' }}>

        {/* Scroll buttons */}
        <button onClick={() => scrollCarousel('left')}
          style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 32, zIndex: 5,
        ...
        <button onClick={() => scrollCarousel('right')}
          style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: 32, zIndex: 5,
        ...
        <div ref={carouselRef}
          style={{ display: 'flex', gap: 10, overflowX: 'auto', padding: '12px 40px',
              ...
              <div key={c.id}
                ...
                {isSelected && (
                  <div style={{ position: 'absolute', top: 0, left: 0, right: 0,
                    ...
                    <span style={{ fontSize: 8, fontFamily: "'Rajdhani', sans-serif", fontWeight: 700,
                      letterSpacing: '0.15em', color: '#22c55e' }}>SELECTED</span>
                  </div>
                )}
                ...
                <div style={{ padding: '0 10px 10px', textAlign: 'left' }}>
                  ...
                  <div style={{ fontSize: 9, color: '#4b6280', fontFamily: "'Rajdhani', sans-serif",
